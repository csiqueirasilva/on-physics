...
;(function (globalScope) {
  ...
  P.multFullCircle = multFullCircle;
  ...
  function clone(obj) {
	...
	Decimal.toRad = toRad;
	Decimal.toDegree = toDegree;
	Decimal.multFullCircle = multFullCircle;
  ...
  function toRad() {
	...
	return (pi.div("180")).mul(this);
  }

  function multFullCircle() {
	var x = this,
      Ctor = x.constructor,
      pr = Ctor.precision,
      rm = Ctor.rounding;
  ...
  // Browser.
	...
	globalScope.getDecimalPI = function () {
		var x = Decimal(0),
		  Ctor = x.constructor,
		  pr = Ctor.precision,
		  rm = Ctor.rounding;
	  
		return getPi(Ctor, pr, rm);
	};
  }
})(this);
